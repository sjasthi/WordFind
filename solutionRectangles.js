/**
 * Created by Jim on 4/6/2016.
 */

/**
 * Variable that holds the references for the triangles
  * @type {Array}
 */
var rectangles = [];
// Browser configs
...
function changeCSS(element, elementRef, direction, length) {
    ...
    switch (direction) {
        ...
        case 4:
            ...
            document.getElementById(element).style.transform = 'rotate(270deg)';
            break;
        case 5:
            document.getElementById(element).style.msTransform = 'rotate(45deg)'; /* IE 9 */
            document.getElementById(element).style.transform = 'rotate(45deg)';
            break;
        case 6:
            document.getElementById(element).style.msTransform = 'rotate(225deg)'; /* IE 9 */
            document.getElementById(element).style.transform = 'rotate(225deg)';
            break;
        case 7:
            document.getElementById(element).style.msTransform = 'rotate(135deg)'; /* IE 9 */
            document.getElementById(element).style.transform = 'rotate(135deg)';
            break;
        case 8:
            document.getElementById(element).style.msTransform = 'rotate(315deg)'; /* IE 9 */
            document.getElementById(element).style.transform = 'rotate(315deg)';
