...
<div class="container">
    ...
    <div class="card mt-4 mb-4">
        <div class="card-header"><strong>Timberwolves</strong> &nbsp;<span class="small">MN based team whose only good seasons were with Garnett!</span> </div>

        <div class="card-body">
            <!-- <p class="card-text">This NBA team is based out of MN and they totally suck!</p> -->
            <p class="card-text">Word List: Wolves, Garnett, Towns, Russell, Beasley, Okogie, Reid, Layman</p>
        </div>
    </div>
