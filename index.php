...
?>
    ...
    <div class="col-md mt-3">
        <div class="card h-100">
            ...
            <h6 class="mb-0"><a href="category.php?categoryId=<?php echo $category->cat_id; ?>" class="list-group-item list-group-item-action bg-light text-primary"><?php echo $data['cat_name']; ?>
